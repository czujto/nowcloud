...
- [Private DNS at Scale in Azure Landing Zones](/azure/networking/2026/05/29/private-dns-at-scale-in-azure-landing-zones.html) provides a governed enterprise pattern for private endpoint resolution.
- [Designing Pod-Based Global DNS for Azure Landing Zones]({% post_url 2026-06-11-designing-pod-based-global-dns-for-azure-landing-zones %}) connects public delegation, Private DNS and platform pod boundaries.
